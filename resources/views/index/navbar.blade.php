...
<header class="bg-gray-400 shadow fixed w-full z-10">
    <div class="container mx-auto px-4 flex flex-wrap items-center justify-between py-4">
        ...
        <!-- Navigation Links -->
        <nav id="menu" class="hidden md:flex md:flex-col md:space-y-4 lg:space-y-8 items-center font-semibold text-gray-700">
            <ul class="list-none flex md:space-x-4">
                <li><a href="/beranda" class="block text-black-800 hover:text-blue-700 py-2 px-4 md:py-0">Beranda</a></li>
                ...
                <li><a href="/bantuan" class="block text-black-800 hover:text-blue-700 py-2 px-4 md:py-0">Bantuan</a></li>
            </ul>
        </nav>
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="relative group">
                <button class="text-gray-700 font-semibold py-2 px-4 rounded inline-flex items-center focus:outline-none">
            ...
            @else
                <a href="#" onclick="openModal()" class="px-4 py-2 rounded-md border border-gray-300 text-gray-700 hover:text-white hover:bg-blue-700 hover:border-blue-700 focus:outline-none">Log In</a>
            @endauth
        </div>
    </div>
</header>
@if (session('success'))
    <div class="fixed top-1/2 right-1/2 transform translate-x-1/2 translate-y-1/2 bg-green-100 border border-green-400 text-green-700 px-4 py-2 rounded shadow-lg z-50" role="alert">
        <strong class="font-bold">Berhasil!</strong>
        <span class="block sm:inline">{{ session('success') }}</span>
        <button class="absolute top-0 bottom-0 right-0 px-2 py-1" onclick="this.parentElement.style.display='none';">
            <svg class="fill-current h-4 w-4 text-green-500" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><title>Close</title><path d="M14.348 14.849a1 1 0 01-1.414 0L10 11.914l-2.935 2.935a1 1 0 01-1.414-1.414L8.086 10.5 5.151 7.564a1 1 0 111.414-1.414L10 8.586l2.935-2.935a1 1 0 111.414 1.414L11.914 10.5l2.935 2.935a1 1 0 010 1.414z"/></svg>
        </button>
    </div>
@endif
    
@if (session('error'))
    <div class="fixed top-1/2 right-1/2 transform translate-x-1/2 translate-y-1/2 bg-red-100 border border-red-400 text-red-700 px-4 py-2 rounded shadow-lg z-50" role="alert">
...
<div id="modal" class="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center hidden">
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-3xl relative">
            ...
            <div class="flex border-b mb-6">
                <button id="logInTab" class="py-2 px-4 text-gray-600 border-b-2 border-blue-600" onclick="showLogIn()">Login</button>
                <button id="signUpTab" class="py-2 px-4 text-gray-600 border-b-2 hover:border-blue-600" onclick="showSignUp()">Sign Up</button>
            </div>
            <div id="logInForm">
                ...
                <form action="/register" method="post">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div class="mb-2">
                            ...
                            <input class="w-full px-3 py-2 border rounded-lg" type="text" name='name' id="name" placeholder="Enter your name">
                        </div>
                        <div class="mb-2">
                            <label class="block text-gray-700 mb-2" for="email">Email</label>
                            <input class="w-full px-3 py-2 border rounded-lg" type="email" name='email' id="email" placeholder="Enter your email">
                        </div>
                        <div class="mb-2">
                            <label class="block text-gray-700 mb-2" for="password">Password</label>
                            <input class="w-full px-3 py-2 border rounded-lg" type="password" name='password' id="password" placeholder="Enter your password">
                        </div>
                        <div class="mb-2">
                            <label class="block text-gray-700 mb-2" for="password_confirmation">Konfirmasi Password</label>
                            <input class="w-full px-3 py-2 border rounded-lg" type="password" name='' id="password_confirmation" placeholder="Enter your password again">
                            <p class="text-red-600 text-xs" id="password_error"></p>
                        </div>
                        <div class="mb-2">
                            <label class="block text-gray-700 mb-2" for="address">Alamat</label>
                            <input class="w-full px-3 py-2 border rounded-lg" type="text" name='alamat' id="alamat" placeholder="Enter your address">
                        </div>
                        <div class="mb-2">
                            <label class="block text-gray-700 mb-2" for="phone">Nomer HP</label>
                            <input class="w-full px-3 py-2 border rounded-lg" type="text" name='no_hp' id="no_hp" placeholder="Enter your phone number">
                        </div>
