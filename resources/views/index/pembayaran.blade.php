    ...
    <div class="min-h-screen flex flex-col container mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        @else
            ...
            <div class="mb-6 bg-white rounded-lg shadow-md p-6">
                ...
                <ul class="mt-2">
                    <li class="flex items-center"><strong>Nama Paket:</strong> <span class="ml-2">{{ $paket->nama_paket }}</span></li>
                    <li class="flex items-center"><strong>Kecepatan:</strong> <span class="ml-2">{{ $paket->kecepatan }} Mbps</span></li>
                    <li class="flex items-center"><strong>Harga Bulanan:</strong> <span class="ml-2">Rp{{ number_format($paket->harga_bulanan, 0, ',', '.') }}</span></li>
                    <li class="flex"><strong>Deskripsi:</strong> <span class="ml-2">{{ $paket->deskripsi }}</span></li>
                </ul>                        
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <form action="{{ route('pembayaran.proses') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="periode_pembayaran" id="periode_pembayaran" class="w-full p-2 border rounded-lg" onchange="hitungTotalPembayaran()">
                    ...
                    <div class="mb-6">
                        <strong>Total Pembayaran:</strong> <span id="total-pembayaran" class="text-2xl font-bold">Rp{{ number_format($paket->harga_bulanan, 0, ',', '.') }}</span>
                    </div>
