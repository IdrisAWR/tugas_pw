...
<body>
    ...
    <section class="relative bg-cover bg-center h-screen" style="background-image: url('{{ asset('img/bg beranda.jpg') }}')">
        ...
        <div class="relative z-10 flex flex-col items-center justify-center h-full text-center text-white">
            ...
            <div class="flex items-center bg-white rounded-full shadow-md overflow-hidden w-3/4 md:w-1/2 lg:w-1/3">
                <input type="text" placeholder="Cari nomor Handphone/id WiFi disini" class="flex-grow px-4 py-2 text-gray-800 focus:outline-none">
    ...
    <section class="py-16 bg-white text-center">
        <div class="container mx-auto">
            ...
            <p class="text-gray-600 mb-8">Menyediakan koneksi hingga pelosok bumi.<br> Dapat ditemui di seluruh Nusantara.</p>
            <h2 class="text-3xl font-bold mb-4">Daftar, Segera!</h2>
            <p class="text-gray-600 mb-8">Create a free account to get started</p>
            <button onclick="openModal()" class="bg-blue-500 text-white px-6 py-2 rounded-full hover:bg-blue-600">Sign Up</button>
        </div>
    </section>
</body>
